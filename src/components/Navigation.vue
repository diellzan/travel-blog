    ...
    <body>
        <nav class="container">
            <div class="branding">
                <router-link class="header" 
                 :to="{name: 'Home'}"><Logo /></router-link>
            </div>
            <div class="nav-links">
                <ul v-show="!mobile">
                    <router-link class="link" :to="{ name: 'Home' }">Home</router-link>
                    <router-link class="link" :to="{ name: 'Cities' }">Cities</router-link>
                    <router-link class="link" :to="{ name: 'Posts' }">Posts</router-link>
                    <router-link class="link" :to="{ name: 'AboutUs' }">About Us </router-link>
                    <router-link v-if="!user.profileId" class="link" :to="{ name: 'Login' }">Login/Register</router-link>
                    <router-link v-else class="link" :to="{ name: 'Profile' }">{{ user.profileUserName }} </router-link>
                </ul>
                <div v-if="user.profileId" @click="toggleProfileMenu" class="profile" ref="profile">
                        ...
                        <div class="info">
                            ...
                            <div class="right">
                                ...
                                <p>{{ this.$store.state.profileUserName }}
                                   {{ this.$store.state.profileEmail }}</p>   
                            </div>
                        </div>
                        <div class="options">
                            <div class="option">
        ...
        <transition name="mobile-nav">
            <ul class="mobile-nav" v-show="mobileNav">
                <router-link class="link" :to="{ name: 'Home' }">Home</router-link>
                <router-link v-if="isAdmin" class="link" :to="{ name: 'Cities' }">Cities</router-link>
                <router-link class="link"  :to="{ name: 'Posts' }">Create Post</router-link>
                <router-link class="link" :to="{ name: 'AboutUs' }">About Us</router-link>
                <router-link v-if="!user.profileId" class="link" :to="{ name: 'Login' }">Login/Register</router-link>
