<template>
    <div class="container-fluid cityContainer">
        <div class="cityHero">
            <div class="imgShadow">
                <img :src="require('../../../assets/blogPhotos/experiencesFull.jpg')"
                :alt="this.currentCity.id" :onerror="replaceByDefault" class="cityMainImage" />
            </div>
        ...
        <div class="descriptionContainer">
            <h2>
                ...
                guest – ensuring you will remember them for a lifetime. From skiing to
                wild truffle hunting, the surrounding landscape offers an array of
                activities for all four seasons.
            </h2>
        </div>
        <div class="contaier-fluid citySubmenu">
